#exercicio python 11 - Estrutura de Decisão
...
valor_aumento = (salario / 100) * percentual
novo_salario = salario + valor_aumento

print(f'Salário atual é: R$ {salario:,.2f}')
print('Percentual do reajuste é:', percentual,'%')
print(f'Valor do aumento é: R$ {valor_aumento:,.2f}')
