...
print('---------------------------------------------------')
saque = int(input('Informe o valor do seu saque: R$ '))
print('---------------------------------------------------')

while (saque < 10) or (saque > 600):
    print('Valor inválido. Valor sacado deve estar entre R$ 10 e R$ 600')
    saque = int(input('Informe o valor do seu saque: R$ '))
else:
    unidade = saque % 10
    dezena = saque / 10 % 10
...
print('%d nota(s) de 100' % (centena))
print('%d nota(s) de 50' % (cinquenta))
